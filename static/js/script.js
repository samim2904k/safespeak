...
function detectBully(message) {
    return fetch('/detectBully/', {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        if (data.error) {
            ...
            return "Error processing your message."; // Fallback message
        } else {
            console.log("Prediction:", data.prediction);
            return data.prediction; // Return prediction
        }
    })
    .catch(error => {
        console.error("Error:", error.message);
        return "Error connecting to the server."; // Fallback message
    });
}
...
function newMessage() {
    ...
    $(
        '<li class="replies"> <div class="d-flex"> <div class="profile mr-4 bg-size" style="background-image: url(&quot;../static/images/contact/1.jpg&quot;); background-size: cover; background-position: center center;"></div><div class="flex-grow-1"> <div class="contact-name"> <h5>User</h5> <h6>' + time +'</h6> <ul class="msg-box"> <li> <h5>' +
        message +
    ...
    // Introduce delay before processing the bot's response
    setTimeout(() => {
        detectBully(message).then(prediction => {
            time = formatTime(new Date());
            // Replace the typing indicator with the bot's response
            $(".typing-m").remove();
            $(
                '<li class="sent"> <div class="d-flex"> <div class="profile mr-4 bg-size" style="background-image: url(&quot;../static/images/contact/Bot.jpeg&quot;); background-size: cover; background-position: center center;"></div><div class="flex-grow-1"> <div class="contact-name"> <h5>SafeSpeak Bot</h5> <h6>' + time + '</h6> <ul class="msg-box"> <li> <h5>' +
                prediction +
                '</h5> <div class="badge badge-success sm ml-2"> R</div></li></ul> </div></div></div></li>'
            ).appendTo($(".messages .chatappend"));
            $(".messages").animate({ scrollTop: $(document).height() }, "fast");
        });
    }, 2000); // Delay for 2 seconds to show typing animation
}


// Function to show typing indicator
function typingMessage(time) {
    $(
        '<li class="sent last typing-m"> <div class="d-flex"> <div class="profile mr-4 bg-size" style="background-image: url(&quot;../static/images/contact/Bot.jpeg&quot;); background-size: cover; background-position: center center; display: block;"><img class="bg-img" src="../static/images/contact/Bot.jpeg" alt="Avatar" style="display: none;"></div><div class="flex-grow-1"> <div class="contact-name"> <h5>SafeSpeak Bot</h5> <h6>' + time + '</h6> <ul class="msg-box"> <li> <h5> <div class="type"> <div class="typing-loader"></div></div></h5> </li></ul> </div></div></div></li>'
    ).appendTo($(".messages .chatappend"));
    $(".messages").animate({ scrollTop: $(document).height() }, "fast");
}

// Enable "Enter" key and "Send" button functionality
...
function logoutConfirm() {
  ...
  $(".sticker-contain ul li").on("click", function (e) {
    ...
    $(
      '<li class="replies"> <div class="d-flex"> <div class="profile mr-4 bg-size" style="background-image: url("../assets/images/contact/1.jpg"); background-size: cover; background-position: center center;"></div><div class="flex-grow-1"> <div class="contact-name"> <h5>Alan josheph</h5> <h6>01:42 AM</h6> <ul class="msg-box"> <li> <h5>' +
        sticker +
        "</h5> </li></ul> </div></div></div></li>"
    ).appendTo($(".messages .chatappend"));
